...
emailjs.init("kmr9Bom9Zq0EhhI21");
        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/Prabesh619", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/pra_besh_ojha/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/prabesh-ojha-ab1bb422a/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/profile.php?id=100006953054710",
                    "_blank"
                  )
                }
              >
