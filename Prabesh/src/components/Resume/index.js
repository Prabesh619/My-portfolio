      ...
      <div className="grid grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold  text-white ml-28">
              Advance React from coursera
            </h3>
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
              Completed on December 29th, 2012
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
              Create robust and reusable components with advanced techniques 
             and learn different patterns to reuse common behavior.Integrate 
             commonly used React libraries to streamline your application development.
            </p>
            <a
              href="https://www.coursera.org/account/accomplishments/verify/GCKHWCMF3867"
              target="_blank"
              rel="noreferrer"
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            <p class="text-base font-normal text-gray-400">
              Understand the basic concepts and the applications of
               database systems. Master the basics of SQL and 
               construct queries using SQL. Understand the relational
               database design principles.
            </p>
            <a
              href="https://coursera.org/verify/XJU3SFZET"
              target="_blank"
              rel="noreferrer"
          ...
          <li data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
            ...
            <p class="text-base font-normal text-gray-400">
                ...
                Later, I also built a Note app and other applications to
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.coursera.org/account/accomplishments/verify/XTR77KE2YB3N"
              class="inline-flex items-center px-4 py-2 mt-5 text-sm font-medium border rounded-lg focus:z-10 focus:ring-4 focus:outline-none focus:text-blue-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700"
            >
              <svg
                class="w-4 h-4 mr-2"
          ...
          <li class="mb-10" data-aos="zoom-in">
            ...
            <p class="mb-4 text-base font-normal  text-gray-400">
                  Implement Version Control systems along with the process
                   Navigate and configure using the command line. Use a GitHub 
                   repository. Create a GitHub repository 
            </p>
            <a
              href="https://www.coursera.org/account/accomplishments/verify/S7SXKBWNNNXU"
              target="_blank"
              rel="noreferrer"
              class="inline-flex items-center px-4 py-2 mt-2 text-sm font-medium border rounded-lg  focus:z-10 focus:ring-4 focus:outline-none focus:text-blue-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700"
            >
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"Jira"} percent={45} />
            <BarGraph name={"HTML/CSS/Bootstrap"} percent={85} />
            <BarGraph name={"SQL"} percent={65} />
            <BarGraph name={"Project documentation and Presentation"} percent={70} />
            <BarGraph name={"AWS"} percent={30} />
            <BarGraph name={"Quality Assurance"} percent={60} />
            <BarGraph name={"Microsoft excel"} percent={70} />
          </div>

          <a
            href={require("../../assets/files/Prabesh Resume.pdf")}
            download={"Prabesh's Resume"}
